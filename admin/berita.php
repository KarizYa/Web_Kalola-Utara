    ...
    <div class="row">
        ...
        <div class="col-lg-9 admin-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold"><i class="fa-regular fa-calendar"></i> Kelola Informasi</h2>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <?php if($page > 1): ?>
                                    <li class="page-item"><a class="page-link" href="berita.php?keyword=<?= urlencode($keyword) ?>&page=<?= $page - 1 ?>">&laquo; Prev</a></li>
                                <?php endif; ?>
                                <?php for($i = 1; $i <= $totalPages; $i++): ?>
                                    <li class="page-item <?= $i === $page ? 'active' : '' ?>"><a class="page-link" href="berita.php?keyword=<?= urlencode($keyword) ?>&page=<?= $i ?>"><?= $i ?></a></li>
                                <?php endfor; ?>
                                <?php if($page < $totalPages): ?>
                                    <li class="page-item"><a class="page-link" href="berita.php?keyword=<?= urlencode($keyword) ?>&page=<?= $page + 1 ?>">Next &raquo;</a></li>
                                <?php endif; ?>
                            </ul>
                        </nav>
                    </div>
