...
<head>
    ...
    <title>Kelola Budaya — Admin Pesona Kolaka Utara</title>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold" style="font-family: var(--font);">
        <i class="fas fa-masks-theater" style="color: var(--accent);"></i> Kelola Budaya
    </h2>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                <a class="page-link" href="budaya.php?keyword=<?= urlencode($keyword) ?>&page=<?= $page-1 ?>" <?= $page <= 1 ? 'tabindex="-1"' : '' ?>>
            ...
            <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                <a class="page-link" href="budaya.php?keyword=<?= urlencode($keyword) ?>&page=<?= $i ?>"><?= $i ?></a>
            </li>
            <?php elseif($i == $page - $range - 1 || $i == $page + $range + 1): ?>
            <li class="page-item dots"><a class="page-link">…</a></li>
            <?php endif; endfor; ?>
            <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                <a class="page-link" href="budaya.php?keyword=<?= urlencode($keyword) ?>&page=<?= $page+1 ?>" <?= $page >= $totalPages ? 'tabindex="-1"' : '' ?>>
