...
$queryBerita = mysqli_query($conn, "SELECT * FROM informasi WHERE status='Publish' AND jenis='Berita' ORDER BY created_at DESC");
?>
...
<head>
    ...
    <title>Berita Kolaka Utara</title>
...
<section class="hero-page text-center">
    <div class="container">
        <h1 class="display-4 fw-bold">Berita Terkini</h1>
...
<section class="py-5">
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold text-primary-color h4 mb-1">Daftar Berita</h2>
                <p class="text-muted small mb-0">Berita terhangat seputar Kolaka Utara</p>
            </div>
            <div>
